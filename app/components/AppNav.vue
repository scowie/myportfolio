        ...
        <md-sidenav class="md-left" ref="leftSidenav" @open="open('Left')" @close="close('Left')">
            ...
            <md-list>
                <md-list-item href="mailto:cowiestephenjames@gmail.com">
                    <md-icon>
                        <svg width="20px" height="20px" viewBox="0 0 47 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
