const PortfolioManager = {
    ...
    timeline: '2016',
    description: 'Portfolio Manager is a <b><i>content management system (CMS)</i></b> that allows owners of portfolio presentation websites to control what is displayed on those sites.  Built with <a href="https://facebook.github.io/react/" target="_blank">React.js</a>, predictable state behavior in the UI is achieved through a <b><i>unidirectional data flow</i></b> pattern using <a href="http://redux.js.org/" target="_blank">Redux</a>.  A <b><i>REST</i></b> api (<a href="https://nodejs.org/en/" target="_blank">Node.js</a> and <a href="http://expressjs.com/" target="_blank">Express</a>) handles http requests from the UI and stores JSON data in a non-relational, document database (<a href="https://www.mongodb.com/" target="_blank">MongoDB</a>).  A material design library (<a href="http://www.material-ui.com/#/" target="_blank">Material-UI</a>) is leveraged heavily to create a modern, sensible look.  The product is simple and intuitive, delivering just what the user needs.  Some key features that make this product a pleasure to use include: <b><i>drag and drop</i></b> for ordering galleries and images, <b><i>auto-save</i></b> as changes are made, and useful, but subtle and tastefully presented <b><i>notifications</i></b>.',
    tags: [
