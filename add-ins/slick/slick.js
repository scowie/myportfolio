    ...
    Slick = (function() {
        ...
        function Slick(element, settings) {
            ...
            _.defaults = {
                ...
                arrows: true,
                asNavFor: null,
                prevArrow: '<button type="button" data-role="none" style="color:red; height:40px; width:40px; border-radius:20px; position:absolute; z-index:2;top:70px; left:25px;" aria-label="Previous" tabindex="0" role="button"><i class="material-icons" style="font-size:48px; position:absolute; left:-5px; top:-5px;">navigate_before</i></button>',
